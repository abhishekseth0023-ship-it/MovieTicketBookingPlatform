      ...
      <div className={contactStyles.contentContainer}>
        <div className={contactStyles.headerContainer}>
          ...
          <p className={contactStyles.headerSubtitle}>
            Need help with bookings or have questions about MovieSeatHub? Feel free to contact us anytime.
          </p>
        </div>
          ...
          <div className="space-y-6">
            ...
            <div className={contactStyles.cardRelative}>
              ...
              <div className={contactStyles.cardContainer}>
                ...
                <h2 className={contactStyles.formTitle}>Contact Details</h2>
                ...
                <div className={contactStyles.contactInfo}>
                  <div className={contactStyles.contactItem}>
                    ...
                    <div>
                      <h3 className={contactStyles.contactText}>Support Hotline</h3>
                      <p className={contactStyles.contactDetail}>+91 7044050010</p>
                    </div>
                  </div>
                  ...
                  <div className={contactStyles.contactItem}>
                    ...
                    <div>
                      ...
                      <p className={contactStyles.contactDetail}>bookings@movieseathub.com</p>
                      <p className={contactStyles.contactDetail}>support@movieseathub.com</p>
                    </div>
                  </div>
                  ...
                  <div className={contactStyles.contactItem}>
                    ...
                    <div>
                      ...
                      <p className={contactStyles.contactDetail}>PVR Avani Riverside Mall and SVF Cinemas at Platina Mall Howrah Maidan, Kolkata</p>
                      <p className={contactStyles.contactSubDetail}>Serving customers across India</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className={contactStyles.cardRelative}>
              ...
              <div className={contactStyles.emergencyCard}>
                ...
                <p className={contactStyles.emergencyText}>
                  For urgent booking issues or payment issues, contact our support team.
                </p>
                <div className="flex items-center">
                  <div className={contactStyles.emergencyHotline}>
                    HELP DESK : +91 7044350010
                  </div>
                  <span className={contactStyles.emergencyNote}>Available 24/7</span>
                </div>
              </div>
            </div>
          </div>
